...
sp_lbp_sets = build_specialist_set_for_many_classes(X_lbp, labels, image_categories, verbose=False)
sp_glcm_sets = build_specialist_set_for_many_classes(X_glcm, labels, image_categories, verbose=False)
sp_lpq_sets = build_specialist_set_for_many_classes(X_lpq, labels, image_categories, verbose=False)
